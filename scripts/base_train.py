...
parser.add_argument("--depth-memory-layers", type=int, default=0, help="enable sparse depth-memory attention by allowing each layer to attend to the previous K hidden states (0 disables)")
